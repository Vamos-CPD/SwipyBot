...
# Thread pool for parallel face detection/swapping
...
async def _process_video_swap(source_face, target_video_path: str, progress_message, bot, chat_id) -> str | None:
    ...
    try:
        ...
        for frame_idx in range(total_frames):
            ...
            # Process frame in the thread pool
            frame_bgr = await loop.run_in_executor(executor, process_frame, frame, source_face)
